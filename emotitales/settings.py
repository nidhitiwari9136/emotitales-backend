"""
Django settings for emotitales project.
...
SECRET_KEY = 'django-insecure-zd7nq%+^we0!h3r15bo)g1yns6r9&13h=hdz@x5uh@ru6uddz$'
...
WSGI_APPLICATION = 'emotitales.wsgi.application'
